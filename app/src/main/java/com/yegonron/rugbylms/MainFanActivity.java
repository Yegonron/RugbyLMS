...
public class MainFanActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void updateUI(FirebaseUser currentUser) {
        ...
        adapter = new FirebaseRecyclerAdapter<PostModel, MainFanActivity.PostViewHolder>(options) {

            @NonNull
            @Override
            public MainFanActivity.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                return new MainFanActivity.PostViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull MainFanActivity.PostViewHolder holder, int position, @NonNull PostModel model) {
                ...
                holder.commentPostButton.setOnClickListener(v -> {
                    Intent singleActivity = new Intent(MainFanActivity.this, SinglePostActivity.class);
                ...
                holder.likePostButton.setOnClickListener(v -> {
                    ...
                    if (user != null) {
                        ...
                        Toast.makeText(MainFanActivity.this, "please login", Toast.LENGTH_SHORT).show();
