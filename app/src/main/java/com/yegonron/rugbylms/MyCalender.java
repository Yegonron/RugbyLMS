...
public class MyCalender extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        return new DatePickerDialog(getActivity(), ((view, year, month, dayOfMonth) -> onCalenderOkClickListener.onClick(year, month, dayOfMonth)), calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
    }
