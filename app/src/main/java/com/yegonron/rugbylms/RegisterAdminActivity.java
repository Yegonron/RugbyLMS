...
public class RegisterAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView noAccountAdminTv = findViewById(R.id.noAccountAdminTv);
        ...
        noAccountAdminTv.setOnClickListener(v -> startActivity(new Intent(RegisterAdminActivity.this, SignUpActivity.class)));
