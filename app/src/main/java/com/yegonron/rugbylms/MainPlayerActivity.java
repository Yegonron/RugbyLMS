...
public class MainPlayerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void updateUI(FirebaseUser currentUser) {
        ...
        adapter = new FirebaseRecyclerAdapter<Post, MainPlayerActivity.PostViewHolder>(options) {
            ...
            @NonNull
            @Override
            public MainPlayerActivity.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                return new MainPlayerActivity.PostViewHolder(view);
            }
            ...
            protected void onBindViewHolder(@NonNull MainPlayerActivity.PostViewHolder holder, int position, @NonNull Post model) {
                ...
                holder.commentPostButton.setOnClickListener(v -> {
                    Intent singleActivity = new Intent(MainPlayerActivity.this, SinglePostActivity.class);
                ...
                holder.likePostButton.setOnClickListener(v -> {
                    ...
                    if (user != null) {
                        ...
                        Toast.makeText(MainPlayerActivity.this, "please login", Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.profile:
                Intent intent = new Intent(MainPlayerActivity.this, ProfileEditPlayerActivity.class);
                startActivity(intent);
                break;

            case R.id.attendance:
                Intent intent1 = new Intent(MainPlayerActivity.this, PlayerAttendanceActivity.class);
                startActivity(intent1);
                break;

            case R.id.gameFixtures:
                Intent intent2 = new Intent(MainPlayerActivity.this, GameFixturesActivity.class);
                startActivity(intent2);
                break;

            case R.id.leagueTable:
                Intent intent3 = new Intent(MainPlayerActivity.this, LeagueTableActivity.class);
                startActivity(intent3);
                break;

            case R.id.livestreamGames:
                Intent intent4 = new Intent(MainPlayerActivity.this, LivestreamGamesActivity.class);
