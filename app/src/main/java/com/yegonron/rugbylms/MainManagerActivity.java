...
public class MainManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editProfileBtn.setOnClickListener(v -> startActivity(new Intent(MainManagerActivity.this, ProfileEditManagerActivity.class)));
        settingsBtn.setOnClickListener(v -> startActivity(new Intent(MainManagerActivity.this, SettingsActivity.class)));
