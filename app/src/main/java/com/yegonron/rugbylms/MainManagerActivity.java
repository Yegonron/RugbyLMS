...
public class MainManagerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void updateUI(FirebaseUser currentUser) {
        ...
        adapter = new FirebaseRecyclerAdapter<PostModel, MainManagerActivity.PostViewHolder>(options) {

            @NonNull
            @Override
            public MainManagerActivity.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                return new MainManagerActivity.PostViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull MainManagerActivity.PostViewHolder holder, int position, @NonNull PostModel model) {
                ...
                holder.commentPostButton.setOnClickListener(v -> {
                    Intent singleActivity = new Intent(MainManagerActivity.this, SinglePostActivity.class);
                ...
                holder.likePostButton.setOnClickListener(v -> {
                    ...
                    if (user != null) {
                        ...
                        Toast.makeText(MainManagerActivity.this, "please login", Toast.LENGTH_SHORT).show();
