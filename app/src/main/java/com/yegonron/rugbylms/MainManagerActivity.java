...
public class MainManagerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void updateUI(FirebaseUser currentUser) {
        ...
        adapter = new FirebaseRecyclerAdapter<Post, MainManagerActivity.PostViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull MainManagerActivity.PostViewHolder holder, int position, @NonNull Post model) {
