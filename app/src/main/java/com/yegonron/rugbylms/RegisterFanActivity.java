...
public class RegisterFanActivity extends AppCompatActivity {
    ...
    private EditText surNameEt, firstNameEt, lastNameEt, emailEt, passwordEt, cPasswordEt;
    ...
    private String surName, firstName, lastName, email, password;
    ...
    private void saveFirebaseData() {
        ...
        if (image_uri == null) {
            ...
            ref.child(Objects.requireNonNull(firebaseAuth.getUid())).setValue ( hashMap ).addOnSuccessListener (unused -> {
                // db updated
                progressDialog.dismiss ();
                startActivity ( new Intent ( RegisterFanActivity.this, MainFanActivity.class ) );
                finish();
            })
                    .addOnFailureListener (e -> {
                        // failed updating db
