...
public class TeamGroupsManagerAdapter extends RecyclerView.Adapter<TeamGroupsManagerAdapter.TeamListAdapterViewHolder> {
    ...
    public TeamGroupsManagerAdapter(Context context, ArrayList<String> teamGroupManagerList, DatabaseReference database) {
        ...
        this.teamGroupManagerList = teamGroupManagerList;
    ...
    public void onBindViewHolder(@NonNull TeamListAdapterViewHolder holder, int position) {
        ...
        holder.groupName.setText(teamGroupManagerList.get(position));
        database.child("Users").orderByChild("teamname").equalTo(teamGroupManagerList.get(position)).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public int getItemCount() {
        return teamGroupManagerList.size();
    }
    ...
    public class TeamListAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        public TeamListAdapterViewHolder(@NonNull View itemView) {
            ...
            cardView.setOnClickListener(v -> switchVisibility(groupName, cardView, imageView, linearLayout, layout, teamGroupManagerList.get(getAdapterPosition()), database, context));
        }
    }
